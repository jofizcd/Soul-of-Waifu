...
class InterfaceSignals():
    ...
    def create_inworld_widgets(self, character_name):
        ...
        model_combo.view().setMinimumWidth(360)
        model_combo.view().setMaximumHeight(220)
        ...
        load_voices_button.setFixedHeight(40)
        load_voices_button.setCursor(Qt.CursorShape.PointingHandCursor)
        load_voices_button.setStyleSheet(button_style)
