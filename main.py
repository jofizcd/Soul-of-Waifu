...
"Once you\'re ready, create your unique character and start the conversation!"))
        ...
        self.ui.comboBox_conversation_method.setItemText(2, self.translations.get("provider_name_local", "Local LLM"))
        self.ui.comboBox_conversation_method.setItemText(9, self.translations.get("conversation_method_item_openrouter", "OpenRouter"))
