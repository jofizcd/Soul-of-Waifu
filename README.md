...
<h3 align="center">🌌 One character. Multiple dimensions. 🌌</h3>
...
<p align="center">
  <img style="width:95%; border-radius: 12px; box-shadow: 0 8px 30px rgba(0,0,0,0.6);" alt="Soul of Waifu v2.4.0 Interface" src="assets/readme/preview.gif">
</p>
...
3. **Soul Stage RPG Engine** running a full tabletop text-RPG driven by a dedicated AI Game Master.
4. **Soul Companion** desktop overlay living on your screen with neurohormonal simulation, Computer Vision, and MCP tool access.
...
### 1. One Character, Three Modes

| Mode | Description |
|---|---|
| 🧠 **Soul Memory** | Each character has an independent digital brain that goes far beyond basic fact-searching. |
| 💬 **Text & Voice Chat** | Full-duplex conversation with Live2D (motion-linked) & VRM (3D) avatars, custom state variable HUD, lorebooks, and voice calls. |
| 🎲 **Soul Stage** | Turn-based RPG system under a virtual Game Master with WorldState tracking, inventory, status effects, dynamic NPCs, choices bar, and ambient audio. |
| 🖥️ **Soul Companion** | Transparent desktop overlay powered by neurohormones. Reads your screen, interacts with clipboard, uses web tools, and talks proactively. |
...
- **Episodic Topic Archive**: Categorized knowledge base indexing locations, events, and key facts using local `all-MiniLM-L6-v2` embeddings.
...
#### Cognitive Profiles (Hardware Scalability)
...
### 🖥️ Soul Companion — Desktop Companion & MCP Assistant
...
- **10 Cloud Providers Supported:** OpenRouter, OpenAI, Anthropic Claude, DeepSeek, Grok (xAI), Google Gemini, Qwen, Mistral AI, Z.AI, and custom OpenAI-compatible endpoints.
